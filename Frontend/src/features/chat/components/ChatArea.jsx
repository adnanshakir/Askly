              ...
              >
                ...
                >
                  {message.sender === "user" ? (
                    ...
                    <div className="markdown-body wrap-break-word [&_a]:underline [&_code]:rounded [&_code]:bg-(--input) [&_code]:px-1 [&_pre]:overflow-x-auto [&_pre]:rounded-lg [&_pre]:bg-(--input) [&_pre]:p-3 [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_p]:mb-2 [&_p:last-child]:mb-0">
